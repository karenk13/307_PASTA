...
public class TestAssignmentManager {
	...
	@Test public void testNumAssignments(){
		...
		aM.addAssignment("Test1", "Desc", "06/07/2017", 10);
		aM.addAssignment("Test2", "Desc", "06/12/2017", 10);
		aM.addAssignment("Test3", "Desc", "06/27/2017", 10);
	...
	@Test public void testDeleteAssignment(){
		...
		aM.addAssignment(a);
		aM.addAssignment("Test2", "Desc", "06/13/2017", 10);
		aM.addAssignment("Test3", "Desc", "06/19/2017", 10);
